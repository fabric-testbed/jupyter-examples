...
sudo ip netns exec frrouting  ${path}/node_tools/config_ifaces.py ${path}/ip_config/ifaces/eth*.json 
sudo ip netns exec frrouting  ${path}/node_tools/config_routes.py ${path}/ip_config/routes/routes.json
sudo ip netns exec frrouting  ${path}/node_tools/host_tune.sh 
